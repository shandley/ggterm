...
**AI Integration.** Eight deterministic skills for Claude Code [@anthropic2024claude] enable natural language workflows from data loading through publication export. The Grammar of Graphics design supports iterative refinement: each modification layers onto existing specifications.
